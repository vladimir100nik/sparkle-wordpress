...
<div class="section">
    ...
    <div class="aim">
        ...
        <h2 class="page_title">MISIJA</h2>
        <h3>SparkleHeart ir Latvijā un pasaulē atpazīts zīmols</h3>
    </div>
</div>
